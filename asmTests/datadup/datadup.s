...
## BB#2:
	...
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+62], 5
	...
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+62]
	add	al, -5
	shr	al, 7
...
## BB#3:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+66], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+66]
	shr	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_10
## BB#4:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+65], 5
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+65], 5
	...
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+65]
	add	al, -5
	shr	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
...
## BB#7:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+57], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+57]
	shr	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_10
## BB#8:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+61], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5039]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+61]
	shr	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_10
...
LBB0_15:
	...
	jmp	LBB0_16
LBB0_13:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5551]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5555]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5551]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5551], eax
	cmp	eax, 4096
	jae	LBB0_14
LBB0_16:
...
LBB0_18:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5551]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5551], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5267]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5039]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5035]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5035], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21939]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21943
	mov	dword ptr [ebx + (_m-L1$pb)+21939], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5035]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408247]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5039]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.54-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5039]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5039], 4280247
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5035]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5035], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5039], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.9-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4267], cl
...
_m:
	...
	.space	4,5
	.space	5
	.ascii	"\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003\000\002\004\003"
	.space	4096
	.space	768
	.long	1                       ## 0x1
	.space	512
...
L_.str.4:                               ## @.str.4
	.asciz	"xox %x (from beg RW) %x:var0\n"

L_.str.5:                               ## @.str.5
	.asciz	"xox %x (from beg RW) %x:var\n"
