...
R(STI);
R(CLD);
R(CMP(8,*((db *) realAddress(offsetof(struct Mem,var1), ds)),8,(db)2));
R(JNE(failure));
R(CMP(8,*((db *) realAddress(offsetof(struct Mem,var1), ds)),8,(db)2));
R(JNE(failure));
R(JMP(exitlabel));
...
R(JNE(failure));
R(CMP(16,*((dw *) realAddress(offsetof(struct Mem,var2), ds)),16,(dw)4));
R(JNE(failure));
R(CMP(16,*((dw *) realAddress((offsetof(struct Mem,var2)+2), ds)),16,(dw)6));
R(JNE(failure));
R(CMP(32,*((dd *) realAddress(offsetof(struct Mem,var3), ds)),32,(dd)11));
R(JNE(failure));
R(CMP(32,*((dd *) realAddress((offsetof(struct Mem,var3)+(3*4)), ds)),32,(dd)4000000));
R(JNE(failure));
R(CMP(32,*((dd *) realAddress((offsetof(struct Mem,var3)+(3*4)), ds)),32,(dd)4000000));
R(JNE(failure));
R(MOV(32,READDD(ebp),32,(dd)(3*4)));
R(CMP(32,*((dd *) realAddress((offsetof(struct Mem,var3)+READDD(ebp)), ds)),32,(dd)4000000));
R(JNE(failure));
R(CMP(32,*((dd *) realAddress((offsetof(struct Mem,var3)+READDD(ebp)), ds)),32,(dd)4000000));
R(JNE(failure));
