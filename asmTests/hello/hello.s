...
## BB#2:
	...
	mov	dword ptr [esi + (_m-L0$pb)+12], 52
	sub	esp, 12
	push	33
	call	_asm2C_INT
	add	esp, 16
...
LBB0_14:
	...
	jmp	LBB0_15
LBB0_4:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5467]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5471]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5467]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5467], eax
	cmp	eax, 4096
	jb	LBB0_15
## BB#5:
...
LBB0_17:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5467]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5467], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5183]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+4955]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4951]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+4951], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21855]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21859
	mov	dword ptr [ebx + (_m-L1$pb)+21855], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+4951]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408163]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+4955]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.51-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+4955]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+4955], 4280163
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4951]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+4951], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+4955], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.6-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4183], cl
...
_m:
	...
	.byte	0                       ## 0x0
	.byte	0                       ## 0x0
	.ascii	"Hello World From Protected Mode!\n\r$"
	.space	4096
	.space	768
	.long	1                       ## 0x1
	.space	512
...
L_.str.4:                               ## @.str.4
	.asciz	"xox %x (from beg RW) %x:_msg\n"
