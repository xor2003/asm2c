...
## BB#1:
	...
	jne	LBB0_45
## BB#2:
	mov	dword ptr [esi + _m-L0$pb], 1048576
	movzx	eax, word ptr [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+8], ax
	mov	dword ptr [esi + _m-L0$pb], 16
	movzx	eax, word ptr [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+4], ax
	mov	word ptr [esi + _m-L0$pb], 1281
	sub	esp, 12
	push	49
	call	_asm2C_INT
	add	esp, 16
...
## BB#8:
	...
	jmp	LBB0_9
LBB0_10:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+4]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+5622], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
	add	eax, 2
	mov	dword ptr [esi + (_m-L0$pb)+5618], eax
	cmp	eax, 4096
	jae	LBB0_11
## BB#12:
	movzx	ecx, word ptr [esi + (_m-L0$pb)+8]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+5622], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
	add	eax, 2
	mov	dword ptr [esi + (_m-L0$pb)+5618], eax
	...
	jae	LBB0_13
## BB#14:
	mov	word ptr [esi + _m-L0$pb], 0
	mov	byte ptr [esi + (_m-L0$pb)+45], 1
	mov	byte ptr [esi + (_m-L0$pb)+47], 0
	mov	word ptr [esi + (_m-L0$pb)+8], 1
	sub	esp, 12
	push	49
	call	_asm2C_INT
	add	esp, 16
...
LBB0_4:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5622]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
...
LBB0_19:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
	movzx	ecx, word ptr [esi + 4*eax + (_m-L0$pb)+5614]
	mov	word ptr [esi + (_m-L0$pb)+12], cx
	lea	ecx, [eax - 4]
	mov	dword ptr [esi + (_m-L0$pb)+5618], ecx
	movzx	eax, word ptr [esi + 4*eax + (_m-L0$pb)+5606]
	mov	word ptr [esi + (_m-L0$pb)+8], ax
	movzx	eax, word ptr [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+4], ax
	mov	word ptr [esi + (_m-L0$pb)+38], ax
	mov	word ptr [esi + _m-L0$pb], 7
	sub	esp, 12
	push	49
	call	_asm2C_INT
	add	esp, 16
...
## BB#20:
	...
	je	LBB0_21
LBB0_23:
	mov	dword ptr [esi + _m-L0$pb], 3694591
	movzx	eax, word ptr [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+12], ax
	mov	dword ptr [esi + _m-L0$pb], 56
	movzx	eax, word ptr [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+8], ax
	movzx	eax, word ptr [esi + (_m-L0$pb)+38]
	mov	word ptr [esi + (_m-L0$pb)+4], ax
	mov	word ptr [esi + _m-L0$pb], 8
	sub	esp, 12
	push	49
	call	_asm2C_INT
	add	esp, 16
...
LBB0_32:
	...
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	mov	byte ptr [esi + eax + _m-L0$pb], 55
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	cmp	byte ptr [esi + eax + _m-L0$pb], 55
	...
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	mov	al, byte ptr [esi + eax + _m-L0$pb]
	add	al, -55
	shr	al, 7
...
## BB#33:
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	mov	byte ptr [esi + eax + _m-L0$pb], 56
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	inc	byte ptr [esi + eax + _m-L0$pb]
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	cmp	byte ptr [esi + eax + _m-L0$pb], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	cmp	byte ptr [esi + eax + _m-L0$pb], 57
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	eax, word ptr [esi + (_m-L0$pb)+36]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5106]
	cmp	byte ptr [esi + eax + _m-L0$pb], 57
	...
	je	LBB0_9
## BB#34:
	mov	dword ptr [esi + (_m-L0$pb)+16], 57
	mov	eax, dword ptr [esi + (_m-L0$pb)+5618]
...
LBB0_45:
	...
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5618], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5334]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5106]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5102]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5102], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+22006]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 22010
	mov	dword ptr [ebx + (_m-L1$pb)+22006], ecx
	movzx	ecx, ax
...
LBB1_38:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
	lea	eax, [ebx + L_.str.74-L1$pb]
	jmp	LBB1_27
LBB1_42:
	mov	edx, dword ptr [ebp - 1032] ## 4-byte Reload
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5102]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408314]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5106]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.60-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5106]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5106], 4280314
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5102]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5102], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5106], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.15-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4334], cl
