...
## BB#1:
	...
	jne	LBB0_16
## BB#2:
	mov	dword ptr [esi + _m-L0$pb], 511
	mov	dword ptr [esi + (_m-L0$pb)+4], 255
	mov	cx, word ptr [esi + (_m-L0$pb)+4]
	xor	cx, word ptr [esi + _m-L0$pb]
	mov	eax, ecx
	and	eax, 32768
	mov	word ptr [esi + _m-L0$pb], cx
	shr	eax, 15
	test	cx, cx
...
LBB0_13:
	...
	jmp	LBB0_14
LBB0_4:
	cmp	dword ptr [esi + _m-L0$pb], 256
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	...
	je	LBB0_8
## BB#5:
	mov	dword ptr [esi + (_m-L0$pb)+8], 61695
	mov	dword ptr [esi + (_m-L0$pb)+4], 4095
	mov	al, byte ptr [esi + (_m-L0$pb)+5]
	xor	byte ptr [esi + (_m-L0$pb)+9], al
	cmp	dword ptr [esi + (_m-L0$pb)+8], 65535
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, -65535
	...
	je	LBB0_8
## BB#6:
	mov	dword ptr [esi + (_m-L0$pb)+8], 57089
	or	byte ptr [esi + (_m-L0$pb)+8], -16
	cmp	dword ptr [esi + (_m-L0$pb)+8], 57329
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, -57329
