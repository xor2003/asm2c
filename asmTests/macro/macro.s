...
## BB#2:
	...
	mov	dword ptr [esi + _m-L0$pb], 122
	mov	eax, dword ptr [esi + (_m-L0$pb)+5485]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+36]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+5489], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+5485]
	add	eax, 2
	mov	dword ptr [esi + (_m-L0$pb)+5485], eax
	cmp	eax, 4096
	jae	LBB0_3
## BB#5:
...
## BB#7:
	...
	mov	dword ptr [esi + 4*eax + (_m-L0$pb)+5489], ecx
	mov	eax, dword ptr [esi + (_m-L0$pb)+5485]
	add	eax, 4
	mov	dword ptr [esi + (_m-L0$pb)+5485], eax
	cmp	eax, 4096
...
## BB#9:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5485]
	lea	ecx, [eax + 4]
	mov	dword ptr [esi + (_m-L0$pb)+5485], ecx
	cmp	ecx, 4096
	jae	LBB0_10
## BB#11:
	mov	ecx, dword ptr [esi + 4*eax + (_m-L0$pb)+5489]
	mov	dword ptr [esi + (_m-L0$pb)+4], ecx
	mov	ecx, dword ptr [esi + 4*eax + (_m-L0$pb)+5473]
	mov	dword ptr [esi + _m-L0$pb], ecx
	movzx	ecx, word ptr [esi + 4*eax + (_m-L0$pb)+5465]
	mov	word ptr [esi + (_m-L0$pb)+34], cx
	lea	ecx, [eax - 8]
	mov	dword ptr [esi + (_m-L0$pb)+5485], ecx
	movzx	eax, word ptr [esi + 4*eax + (_m-L0$pb)+5457]
	mov	word ptr [esi + (_m-L0$pb)+36], ax
	cmp	dword ptr [esi + _m-L0$pb], 122
	...
	je	LBB0_12
## BB#13:
	mov	dword ptr [esi + (_m-L0$pb)+4], 45
	mov	dword ptr [esi + (_m-L0$pb)+12], 20
	mov	dword ptr [esi + (_m-L0$pb)+8], 0
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	mov	byte ptr [esi + (_m-L0$pb)+47], 0
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+4973]
	inc	byte ptr [esi + eax + (_m-L0$pb)+52]
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+4973]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+52], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	dword ptr [esi + (_m-L0$pb)+20], 52
	xor	eax, eax
	jmp	LBB0_14
LBB0_12:
	mov	al, 1
...
LBB0_16:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5485]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5489]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
...
LBB0_21:
	...
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5485], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5201]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+4973]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4969]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+4969], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21873]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21877
	mov	dword ptr [ebx + (_m-L1$pb)+21873], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+4969]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408181]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+4973]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.55-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+4973]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+4973], 4280181
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4969]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+4969], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+4973], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.10-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4201], cl
