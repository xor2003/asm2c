...
R(JNE(failure));
R(SHR(32,READDD(eax),32,(dd)1));
R(CMP(32,READDD(eax),32,(dd)1));
R(JNE(failure));
R(MOV(32,READDD(ebx),32,(dd)4294967295));
R(MOV(8,READDBl(ebx),8,(db)255));
R(SHR(8,READDBl(ebx),8,(db)1));
R(CMP(8,READDBl(ebx),8,(db)127));
R(JNE(failure));
R(MOV(32,READDD(ecx),32,(dd)4294967295));
R(MOV(8,READDBh(ecx),8,(db)255));
R(SHR(8,READDBh(ecx),8,(db)1));
R(CMP(8,READDBh(ecx),8,(db)127));
R(JNE(failure));
R(SHL(8,READDBh(ecx),8,(db)2));
R(CMP(8,READDBh(ecx),8,(db)252));
R(JNE(failure));
R(MOV(32,READDD(eax),32,(dd)4));
R(SAR(32,READDD(eax),32,(dd)1));
R(CMP(32,READDD(eax),32,(dd)2));
R(JNE(failure));
R(MOV(32,READDD(eax),32,(dd)((0-4))));
R(SAR(32,READDD(eax),32,(dd)1));
R(CMP(32,READDD(eax),32,(dd)((0-2))));
R(JNE(failure));
R(MOV(32,READDD(eax),32,(dd)((0-8))));
