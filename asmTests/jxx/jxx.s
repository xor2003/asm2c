...
## BB#3:
	...
	jne	LBB0_8
LBB0_4:
	mov	byte ptr [esi + (_m-L0$pb)+4], -64
	lea	ecx, [esi + _m-L0$pb]
	mov	word ptr [esi + (_m-L0$pb)+12], 1
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	mov	dword ptr [esi + (_m-L0$pb)+8], 16711935
	mov	word ptr [esi + (_m-L0$pb)+8], 0
	mov	byte ptr [esi + (_m-L0$pb)+47], 0
	mov	dword ptr [esi + (_m-L0$pb)+16], 55
	movzx	edx, word ptr [esi + (_m-L0$pb)+34]
	mov	edx, dword ptr [esi + 4*edx + (_m-L0$pb)+4924]
	cmp	byte ptr [esi + edx + (_m-L0$pb)+55], 1
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	edx, dword ptr [esi + (_m-L0$pb)+16]
	add	edx, ecx
	movzx	ebx, word ptr [esi + (_m-L0$pb)+34]
	mov	ebx, dword ptr [esi + 4*ebx + (_m-L0$pb)+4924]
...
LBB0_12:
	...
	jmp	LBB0_13
LBB0_10:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5436]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5440]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5436]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5436], eax
	cmp	eax, 4096
	jae	LBB0_11
LBB0_13:
...
LBB0_5:
	...
	cmp	byte ptr [ebx + edx], 4
	setb	dl
	mov	byte ptr [esi + (_m-L0$pb)+44], dl
	mov	edx, dword ptr [esi + (_m-L0$pb)+16]
	add	edx, ecx
	movzx	ebx, word ptr [esi + (_m-L0$pb)+34]
	mov	ebx, dword ptr [esi + 4*ebx + (_m-L0$pb)+4924]
	...
	shr	dl, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], dl
	mov	dl, byte ptr [esi + (_m-L0$pb)+45]
	or	dl, byte ptr [esi + (_m-L0$pb)+44]
	je	LBB0_8
## BB#6:
	mov	edx, dword ptr [esi + (_m-L0$pb)+16]
	add	edx, ecx
	...
	cmp	byte ptr [ebx + edx], 0
	sete	byte ptr [esi + (_m-L0$pb)+44]
	add	ecx, dword ptr [esi + (_m-L0$pb)+16]
	movzx	edx, word ptr [esi + (_m-L0$pb)+34]
	mov	edx, dword ptr [esi + 4*edx + (_m-L0$pb)+4924]
	...
	jne	LBB0_8
## BB#7:
	mov	dword ptr [esi + _m-L0$pb], 4
	mov	word ptr [esi + (_m-L0$pb)+12], 0
...
LBB0_15:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5436]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5436], ecx
	lea	esi, [esi + 4*eax + (_m-L0$pb)+5152]
	lea	eax, [ebp - 88]
	mov	ecx, 18
	mov	edi, eax
	rep movsd
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+4924]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4920]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+4920], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21824]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21828
	mov	dword ptr [ebx + (_m-L1$pb)+21824], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+4920]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408132]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+4924]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.52-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+4924]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+4924], 4280132
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4920]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+4920], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+4924], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.7-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4152], cl
