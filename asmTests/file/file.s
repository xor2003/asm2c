...
## BB#2:
	...
	mov	dword ptr [esi + (_m-L0$pb)+8], 2
	mov	dword ptr [esi + (_m-L0$pb)+20], 65
	mov	dword ptr [esi + (_m-L0$pb)+4], 5
	sub	esp, 12
	lea	ebx, [ebp - 88]
	push	ebx
	call	_setjmp
...
## BB#34:
	...
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+68933]
	cmp	byte ptr [esi + (_m-L0$pb)+48], 0
	mov	ecx, 1953719636
	mov	edx, 1415934836
	cmovne	edx, ecx
	cmp	dword ptr [esi + eax + (_m-L0$pb)+65], edx
	mov	edx, 1415934836
	...
	mov	ebx, 1415934836
	cmovne	ebx, ecx
	cmp	dword ptr [esi + eax + (_m-L0$pb)+65], ebx
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+68933]
	mov	eax, dword ptr [esi + eax + (_m-L0$pb)+65]
	cmp	byte ptr [esi + (_m-L0$pb)+48], 0
	cmovne	edx, ecx
	sub	eax, edx
	shr	eax, 31
...
LBB0_40:
	...
	jmp	LBB0_41
LBB0_3:
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+69449]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+69445], eax
	cmp	eax, 4096
	jae	LBB0_4
## BB#6:
	movsd	xmm0, qword ptr [esi + (_m-L0$pb)+24] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + 4*eax + (_m-L0$pb)+69473], xmm0
	movsd	xmm0, qword ptr [esi + (_m-L0$pb)+16] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + 4*eax + (_m-L0$pb)+69465], xmm0
	movsd	xmm0, qword ptr [esi + (_m-L0$pb)+8] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + 4*eax + (_m-L0$pb)+69457], xmm0
	movsd	xmm0, qword ptr [esi + _m-L0$pb] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + 4*eax + (_m-L0$pb)+69449], xmm0
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	add	eax, 32
	mov	dword ptr [esi + (_m-L0$pb)+69445], eax
	cmp	eax, 4096
	jae	LBB0_7
## BB#8:
	movzx	ecx, word ptr [esi + (_m-L0$pb)+36]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+69449], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	add	eax, 2
	mov	dword ptr [esi + (_m-L0$pb)+69445], eax
	cmp	eax, 4096
...
## BB#10:
	...
	jae	LBB0_11
## BB#12:
	mov	dword ptr [esi + (_m-L0$pb)+12], 56
	mov	dword ptr [esi + _m-L0$pb], 0
	mov	byte ptr [esi + (_m-L0$pb)+45], 1
	mov	byte ptr [esi + (_m-L0$pb)+47], 0
	mov	word ptr [esi + _m-L0$pb], 15616
	sub	esp, 12
	push	33
	call	_asm2C_INT
	add	esp, 16
...
## BB#13:
	...
	je	LBB0_14
LBB0_16:
	cmp	byte ptr [esi + (_m-L0$pb)+44], 0
	jne	LBB0_17
## BB#19:
	mov	eax, dword ptr [esi + _m-L0$pb]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+68933]
	mov	dword ptr [esi + ecx + (_m-L0$pb)+52], eax
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+68933]
	mov	eax, dword ptr [esi + eax + (_m-L0$pb)+52]
	mov	dword ptr [esi + (_m-L0$pb)+4], eax
	mov	word ptr [esi + _m-L0$pb], 16896
	movzx	eax, word ptr [esi + (_m-L0$pb)+8]
	mov	word ptr [esi + (_m-L0$pb)+12], ax
	movzx	eax, word ptr [esi + (_m-L0$pb)+10]
	mov	dword ptr [esi + (_m-L0$pb)+8], eax
	sub	esp, 12
	push	33
	call	_asm2C_INT
	add	esp, 16
...
LBB0_23:
	...
	mov	eax, dword ptr [esi + eax + (_m-L0$pb)+52]
	mov	dword ptr [esi + (_m-L0$pb)+4], eax
	mov	byte ptr [esi + (_m-L0$pb)+1], 63
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+69449], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	...
	jae	LBB0_24
## BB#25:
	mov	eax, dword ptr [esi + (_m-L0$pb)+20]
	mov	dword ptr [esi + (_m-L0$pb)+12], eax
	sub	esp, 12
	push	33
	call	_asm2C_INT
	add	esp, 16
...
LBB0_29:
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	lea	ecx, [eax - 2]
	mov	dword ptr [esi + (_m-L0$pb)+69445], ecx
	movzx	eax, word ptr [esi + 4*eax + (_m-L0$pb)+69441]
	mov	word ptr [esi + (_m-L0$pb)+34], ax
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+68933]
	mov	eax, dword ptr [esi + eax + (_m-L0$pb)+52]
	mov	dword ptr [esi + (_m-L0$pb)+4], eax
	mov	byte ptr [esi + (_m-L0$pb)+1], 62
	sub	esp, 12
	push	33
	call	_asm2C_INT
	add	esp, 16
...
LBB0_43:
	...
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+69445], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+69161]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB0_33:
	mov	eax, dword ptr [esi + (_m-L0$pb)+69445]
	movzx	ecx, word ptr [esi + 4*eax + (_m-L0$pb)+69441]
	mov	word ptr [esi + (_m-L0$pb)+34], cx
	movzx	ecx, word ptr [esi + 4*eax + (_m-L0$pb)+69433]
	mov	word ptr [esi + (_m-L0$pb)+36], cx
	movsd	xmm0, qword ptr [esi + 4*eax + (_m-L0$pb)+69329] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + (_m-L0$pb)+24], xmm0
	movsd	xmm0, qword ptr [esi + 4*eax + (_m-L0$pb)+69321] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + (_m-L0$pb)+16], xmm0
	movsd	xmm0, qword ptr [esi + 4*eax + (_m-L0$pb)+69313] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + (_m-L0$pb)+8], xmm0
	movsd	xmm0, qword ptr [esi + 4*eax + (_m-L0$pb)+69305] ## xmm0 = mem[0],zero
	movsd	qword ptr [esi + _m-L0$pb], xmm0
	lea	ecx, [eax - 108]
	mov	dword ptr [esi + (_m-L0$pb)+69445], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+69017]
	jmp	LBB0_18
LBB0_17:
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+68933]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+68929]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+68929], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+85833]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 85837
	mov	dword ptr [ebx + (_m-L1$pb)+85833], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+68929]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4472141]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+68933]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+68933]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+68933], 4344141
	mov	eax, dword ptr [ebx + (_m-L1$pb)+68929]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+68929], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+68933], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+68161], cl
...
L_.str.4:                               ## @.str.4
	.asciz	"xox %x (from beg RW) %x:load_handle\n"

L_.str.5:                               ## @.str.5
	.asciz	"xox %x (from beg RW) %x:filename\n"

L_.str.6:                               ## @.str.6
	.asciz	"xox %x (from beg RW) %x:buffer\n"
