...
## BB#2:
	...
	je	LBB0_13
## BB#3:
	mov	dword ptr [esi + (_m-L0$pb)+4], -65025
	mov	cl, byte ptr [esi + (_m-L0$pb)+5]
	mov	edx, ecx
	and	dl, 1
	xor	dl, 1
	mov	byte ptr [esi + (_m-L0$pb)+45], dl
...
LBB0_17:
	...
	jmp	LBB0_18
LBB0_15:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5557]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5561]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5557]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5557], eax
	cmp	eax, 4096
	jae	LBB0_16
LBB0_18:
...
## BB#19:
	...
	ret
LBB0_4:
	mov	dl, byte ptr [esi + (_m-L0$pb)+5]
	mov	ch, dl
	shr	ch
	mov	cl, ch
	and	cl, 1
	xor	cl, 1
	mov	byte ptr [esi + (_m-L0$pb)+45], cl
	cmp	dl, 3
	setb	cl
	cmp	dl, 2
	seta	byte ptr [esi + (_m-L0$pb)+44]
...
## BB#7:
	...
	mov	byte ptr [esi + (_m-L0$pb)+5], 1
	cmp	dword ptr [esi + (_m-L0$pb)+4], 256
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	cl
	mov	byte ptr [esi + (_m-L0$pb)+44], cl
	mov	ecx, -256
	add	ecx, dword ptr [esi + (_m-L0$pb)+4]
	shr	ecx, 31
...
LBB0_20:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5557]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5557], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5273]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5045]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5041]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5041], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21945]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21949
	mov	dword ptr [ebx + (_m-L1$pb)+21945], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5041]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408253]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5045]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5045]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5045], 4280253
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5041]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5041], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5045], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4273], cl
