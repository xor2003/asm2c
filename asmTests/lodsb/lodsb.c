...
R(JNE(failure));
R(MOV(32,READDD(ecx),32,(dd)(m.isLittle?1684234849:1633837924)));
R(XOR(32,READDD(eax),32,(dd)READDD(eax)));
R(LEA(32,m.esi.dd.val,32,(((dd)offsetof(struct Mem,var5)))));
R(LODSD);
R(MOV(32,READDD(ebx),32,(dd)READDD(eax)));
R(CMP(32,READDD(ebx),32,(dd)(m.isLittle?1684234849:1633837924)));
R(JNE(failure));
