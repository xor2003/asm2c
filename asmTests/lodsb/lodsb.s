...
## BB#1:
	...
	jne	LBB0_18
## BB#2:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5561]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+5565], cx
	mov	eax, dword ptr [esi + (_m-L0$pb)+5561]
	lea	ecx, [eax + 2]
	mov	dword ptr [esi + (_m-L0$pb)+5561], ecx
	cmp	ecx, 4096
	jae	LBB0_3
## BB#5:
	mov	dword ptr [esi + (_m-L0$pb)+5561], eax
	movzx	eax, word ptr [esi + 4*eax + (_m-L0$pb)+5565]
	mov	word ptr [esi + (_m-L0$pb)+36], ax
	mov	dword ptr [esi + (_m-L0$pb)+16], 52
	mov	dword ptr [esi + (_m-L0$pb)+20], 77
	mov	dword ptr [esi + _m-L0$pb], -1
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5049]
	...
	je	LBB0_10
## BB#6:
	cmp	byte ptr [esi + (_m-L0$pb)+1], -1
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setne	byte ptr [esi + (_m-L0$pb)+44]
...
## BB#8:
	...
	mov	dword ptr [esi + (_m-L0$pb)+16], 177
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5049]
	mov	eax, dword ptr [esi + eax + (_m-L0$pb)+177]
	mov	dword ptr [esi + _m-L0$pb], eax
	add	dword ptr [esi + (_m-L0$pb)+16], 4
	...
	mov	eax, 1633837924
	cmovne	eax, ecx
	cmp	dword ptr [esi + (_m-L0$pb)+4], eax
	mov	edx, 1633837924
	setb	al
...
LBB0_13:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5561]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5565]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
...
LBB0_18:
	...
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5561], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5277]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5049]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5045]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5045], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21949]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21953
	mov	dword ptr [ebx + (_m-L1$pb)+21949], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5045]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408257]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5049]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5049]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5049], 4280257
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5045]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5045], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5049], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4277], cl
