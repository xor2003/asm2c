...
R(MOV(32,READDD(edx),32,(dd)4));
R(MOV(32,READDD(esi),32,(dd)6));
R(MOV(32,READDD(edi),32,(dd)8));
R(MOV(32,READDD(ebp),32,(dd)9));
R(PUSHAD);
...
R(CMP(32,READDD(esi),32,(dd)0));
R(JNE(failure));
R(CMP(32,READDD(edi),32,(dd)0));
R(JNE(failure));
R(POPAD);
...
R(POP(32,(READDD(ebp))));
R(POP(32,(READDD(eax))));
R(CMP(32,READDD(ebp),32,(dd)9));
R(JNE(failure));
R(XOR(32,READDD(ecx),32,(dd)READDD(ecx)));
R(MOV(32,READDD(ecx),32,(dd)655360));
R(MOV(32,READDD(ebx),32,(dd)61986));
R(PUSH(16,(READDW(ebx))));
R(PUSH(16,(READDW(fs))));
R(POP(16,(READDW(fs))));
R(POP(16,(READDW(ecx))));
R(CMP(32,READDD(ecx),32,(dd)717346));
R(JNE(exitlabel));
