...
## BB#2:
	...
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	add	word ptr [esi + eax + (_m-L0$pb)+179], 50
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	cmp	word ptr [esi + eax + (_m-L0$pb)+179], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	movzx	eax, word ptr [esi + eax + (_m-L0$pb)+179]
	cmp	eax, 50
	setb	al
...
## BB#3:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	add	word ptr [esi + eax + (_m-L0$pb)+179], -25
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	cmp	word ptr [esi + eax + (_m-L0$pb)+179], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
...
## BB#4:
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	cmp	word ptr [esi + eax + (_m-L0$pb)+177], 0
	sete	byte ptr [esi + (_m-L0$pb)+45]
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5085]
	movzx	eax, word ptr [esi + eax + (_m-L0$pb)+177]
	shr	eax, 15
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_8
## BB#5:
	...
	mov	dword ptr [esi + (_m-L0$pb)+4], 1
	mov	byte ptr [esi + (_m-L0$pb)+45], 0
	mov	byte ptr [esi + (_m-L0$pb)+44], 1
	mov	byte ptr [esi + (_m-L0$pb)+47], 1
	mov	byte ptr [esi + (_m-L0$pb)+45], 1
	mov	byte ptr [esi + (_m-L0$pb)+44], 0
	mov	byte ptr [esi + (_m-L0$pb)+47], 0
	mov	dword ptr [esi + _m-L0$pb], -2
	mov	dword ptr [esi + (_m-L0$pb)+4], 2
	mov	byte ptr [esi + (_m-L0$pb)+12], 2
	mov	dword ptr [esi + (_m-L0$pb)+20], 4480
	mov	word ptr [esi + _m-L0$pb], 1285
	mov	al, byte ptr [esi + (_m-L0$pb)+1]
	mov	cl, 10
	mul	cl
	add	byte ptr [esi + _m-L0$pb], al
	mov	byte ptr [esi + (_m-L0$pb)+1], 0
...
LBB0_13:
	...
	jmp	LBB0_14
LBB0_11:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5597]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5601]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5597]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5597], eax
	cmp	eax, 4096
	jae	LBB0_12
LBB0_14:
...
LBB0_16:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5597]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5597], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5313]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5085]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5081]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5081], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21985]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21989
	mov	dword ptr [ebx + (_m-L1$pb)+21985], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5081]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408293]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5085]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5085]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5085], 4280293
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5081]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5081], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5085], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4313], cl
