...
L0$pb:
	pop	esi
	mov	ecx, dword ptr [esi + L___stack_chk_guard$non_lazy_ptr-L0$pb]
...
## BB#2:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5590]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	word ptr [esi + 4*eax + (_m-L0$pb)+5594], cx
	mov	ecx, dword ptr [esi + (_m-L0$pb)+5590]
	lea	eax, [ecx + 2]
	mov	dword ptr [esi + (_m-L0$pb)+5590], eax
	cmp	eax, 4096
	jae	LBB0_3
## BB#5:
	mov	dword ptr [esi + (_m-L0$pb)+5590], ecx
	lea	eax, [esi + _m-L0$pb]
	movzx	ecx, word ptr [esi + 4*ecx + (_m-L0$pb)+5594]
	mov	word ptr [esi + (_m-L0$pb)+36], cx
	mov	dword ptr [esi + (_m-L0$pb)+16], 181
	mov	dword ptr [esi + (_m-L0$pb)+20], 182
	mov	byte ptr [esi + (_m-L0$pb)+45], 0
	mov	dword ptr [esi + (_m-L0$pb)+8], 10
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	lea	edx, [esi + ecx + (_m-L0$pb)+181]
	mov	edi, dword ptr [esi + (_m-L0$pb)+20]
	add	edi, eax
	movzx	ebx, word ptr [esi + (_m-L0$pb)+36]
	add	edi, dword ptr [esi + 4*ebx + (_m-L0$pb)+5078]
	mov	ecx, edi
	sub	ecx, edx
	mov	ebx, ecx
	neg	ebx
	...
	jg	LBB0_9
## BB#6:
	cmp	dword ptr [esi + (_m-L0$pb)+8], 0
	je	LBB0_10
## BB#7:
	xor	ecx, ecx
	.p2align	4, 0x90
LBB0_8:                                 ## =>This Inner Loop Header: Depth=1
	mov	edx, dword ptr [esi + (_m-L0$pb)+16]
	add	edx, eax
	movzx	edi, word ptr [esi + (_m-L0$pb)+34]
	mov	edi, dword ptr [esi + 4*edi + (_m-L0$pb)+5078]
	movzx	edx, byte ptr [edi + edx]
	mov	edi, dword ptr [esi + (_m-L0$pb)+20]
	add	edi, eax
	movzx	ebx, word ptr [esi + (_m-L0$pb)+36]
	mov	ebx, dword ptr [esi + 4*ebx + (_m-L0$pb)+5078]
...
LBB0_9:
	...
	mov	ecx, dword ptr [esi + (_m-L0$pb)+8]
	add	dword ptr [esi + (_m-L0$pb)+20], ecx
	add	dword ptr [esi + (_m-L0$pb)+16], ecx
LBB0_10:
	mov	dword ptr [esi + (_m-L0$pb)+20], 181
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + ecx + (_m-L0$pb)+182], 1
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + ecx + (_m-L0$pb)+182], 0
	sete	byte ptr [esi + (_m-L0$pb)+44]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	mov	cl, byte ptr [esi + ecx + (_m-L0$pb)+182]
	dec	cl
	shr	cl, 7
...
## BB#11:
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	edx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	mov	byte ptr [esi + edx + (_m-L0$pb)+57], 5
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + ecx + (_m-L0$pb)+57], 5
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + ecx + (_m-L0$pb)+57], 5
	...
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	mov	cl, byte ptr [esi + ecx + (_m-L0$pb)+57]
	add	cl, -5
	shr	cl, 7
	mov	byte ptr [esi + (_m-L0$pb)+47], cl
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_19
## BB#12:
	mov	dword ptr [esi + (_m-L0$pb)+16], 56
	mov	dword ptr [esi + (_m-L0$pb)+20], 57
	mov	byte ptr [esi + (_m-L0$pb)+45], 0
	mov	dword ptr [esi + (_m-L0$pb)+8], 10
	movzx	ecx, word ptr [esi + (_m-L0$pb)+34]
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+5078]
	lea	edx, [esi + ecx + (_m-L0$pb)+56]
	mov	ecx, dword ptr [esi + (_m-L0$pb)+20]
	add	ecx, eax
	movzx	edi, word ptr [esi + (_m-L0$pb)+36]
	add	ecx, dword ptr [esi + 4*edi + (_m-L0$pb)+5078]
	mov	edi, ecx
	sub	edi, edx
	mov	ebx, edi
	neg	ebx
...
LBB0_16:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+8]
	add	dword ptr [esi + (_m-L0$pb)+20], eax
	add	dword ptr [esi + (_m-L0$pb)+16], eax
LBB0_17:
	mov	dword ptr [esi + (_m-L0$pb)+20], 56
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+58], 5
	sete	byte ptr [esi + (_m-L0$pb)+45]
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5078]
	cmp	byte ptr [esi + eax + (_m-L0$pb)+58], 5
	...
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+5078]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+58]
	add	al, -5
	shr	al, 7
...
LBB0_22:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5590]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5594]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
...
LBB0_27:
	...
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5590], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5306]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+5078]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5074]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+5074], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21978]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21982
	mov	dword ptr [ebx + (_m-L1$pb)+21978], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+5074]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
	lea	eax, [ebx + L_.str.78-L1$pb]
	jmp	LBB1_27
LBB1_46:
	mov	dword ptr [ebx + (_m-L1$pb)+12], 512
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408286]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+5078]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
	lea	edx, [ebx + L_.str.59-L1$pb]
	lea	esi, [ebp - 1016]
	push	eax
	push	ecx
	push	edx
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+5078]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+5078], 4280286
	mov	eax, dword ptr [ebx + (_m-L1$pb)+5074]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+5074], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+5078], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
	lea	ecx, [ebx + L_.str.14-L1$pb]
	lea	edx, [ebp - 1016]
	push	eax
	push	ecx
	push	1000
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4306], cl
...
LBB10_8:
	sub	esp, 4
	lea	eax, [eax + L_.str.51-L10$pb]
	push	ecx
	jmp	LBB10_7
LBB10_6:
	sub	esp, 8
	lea	eax, [eax + L_.str.50-L10$pb]
LBB10_7:
	push	edx
	push	eax
	call	_log_error
...
L_.str.9:                               ## @.str.9
	.asciz	"xox %x (from beg RW) %x:testoverlap\n"

L_.str.10:                              ## @.str.10
	.asciz	"xox %x (from beg RW) %x:str1\n"

L_.str.11:                              ## @.str.11
	.asciz	"xox %x (from beg RW) %x:str2\n"

L_.str.12:                              ## @.str.12
	.asciz	"xox %x (from beg RW) %x:str3\n"
