...
## BB#1:
	...
	jne	LBB0_29
## BB#2:
	mov	dword ptr [esi + (_m-L0$pb)+12], -2
...
LBB0_3:
	mov	dword ptr [esi + _m-L0$pb], 0
	mov	word ptr [esi + _m-L0$pb], 21845
	cmp	dword ptr [esi + _m-L0$pb], 21845
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, -21845
	add	eax, dword ptr [esi + _m-L0$pb]
	shr	eax, 31
...
## BB#4:
	...
	sar	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+1], al
	mov	eax, dword ptr [esi + _m-L0$pb]
	mov	ecx, eax
	shr	ecx, 31
	test	eax, eax
...
## BB#6:
	...
	je	LBB0_21
## BB#7:
	mov	dword ptr [esi + _m-L0$pb], -253
	mov	al, byte ptr [esi + _m-L0$pb]
	sar	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+1], al
	cmp	dword ptr [esi + _m-L0$pb], -65533
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, 65533
	...
	je	LBB0_21
## BB#8:
	mov	dword ptr [esi + _m-L0$pb], -65293
	mov	al, byte ptr [esi + _m-L0$pb]
	sar	al, 7
	mov	byte ptr [esi + (_m-L0$pb)+1], al
	cmp	dword ptr [esi + _m-L0$pb], -13
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, dword ptr [esi + _m-L0$pb]
...
## BB#10:
	...
	je	LBB0_21
## BB#11:
	cmp	dword ptr [esi + (_m-L0$pb)+12], 65535
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, -65535
	add	eax, dword ptr [esi + (_m-L0$pb)+12]
	shr	eax, 31
	mov	byte ptr [esi + (_m-L0$pb)+47], al
	cmp	byte ptr [esi + (_m-L0$pb)+45], 0
	je	LBB0_21
...
## BB#16:
	...
	movzx	eax, word ptr [esi + _m-L0$pb]
	sar	ax, 15
	mov	word ptr [esi + (_m-L0$pb)+2], ax
	mov	eax, dword ptr [esi + _m-L0$pb]
	mov	ecx, eax
	shr	ecx, 31
	test	eax, eax
...
## BB#18:
	...
	sar	ax, 15
	mov	word ptr [esi + (_m-L0$pb)+2], ax
	cmp	dword ptr [esi + _m-L0$pb], -253
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, 253
...
## BB#19:
	...
	sar	ax, 15
	mov	word ptr [esi + (_m-L0$pb)+2], ax
	cmp	dword ptr [esi + _m-L0$pb], 243
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
	mov	eax, -243
