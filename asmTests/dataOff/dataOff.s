...
## BB#2:
	...
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+4945]
	...
	je	LBB0_9
## BB#3:
	mov	byte ptr [esi + (_m-L0$pb)+8], 2
	lea	eax, [esi + _m-L0$pb]
	mov	ecx, dword ptr [esi + (_m-L0$pb)+20]
	add	ecx, eax
	movzx	edx, word ptr [esi + (_m-L0$pb)+34]
	mov	edx, dword ptr [esi + 4*edx + (_m-L0$pb)+4945]
	mov	byte ptr [edx + ecx], 2
	mov	ecx, dword ptr [esi + (_m-L0$pb)+20]
	add	ecx, eax
	movzx	edx, word ptr [esi + (_m-L0$pb)+34]
	mov	edx, dword ptr [esi + 4*edx + (_m-L0$pb)+4945]
	mov	cl, byte ptr [edx + ecx]
	mov	byte ptr [esi + (_m-L0$pb)+12], cl
	cmp	cl, 2
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	cl
	mov	byte ptr [esi + (_m-L0$pb)+44], cl
	mov	cl, byte ptr [esi + (_m-L0$pb)+12]
	add	cl, -2
	shr	cl, 7
...
## BB#4:
	...
	mov	ecx, dword ptr [esi + 4*ecx + (_m-L0$pb)+4945]
	mov	cl, byte ptr [esi + ecx + (_m-L0$pb)+53]
	mov	byte ptr [esi + (_m-L0$pb)+12], cl
	cmp	cl, 5
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	cl
...
## BB#5:
	...
	je	LBB0_9
## BB#6:
	mov	dword ptr [esi + (_m-L0$pb)+20], 55
	movzx	eax, word ptr [esi + (_m-L0$pb)+34]
	mov	eax, dword ptr [esi + 4*eax + (_m-L0$pb)+4945]
	mov	al, byte ptr [esi + eax + (_m-L0$pb)+55]
	mov	byte ptr [esi + (_m-L0$pb)+12], al
	cmp	al, 4
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
...
## BB#7:
	...
	cmp	dword ptr [esi + (_m-L0$pb)+20], 55
	sete	byte ptr [esi + (_m-L0$pb)+45]
	setb	al
	mov	byte ptr [esi + (_m-L0$pb)+44], al
...
LBB0_14:
	...
	jmp	LBB0_15
LBB0_12:
	mov	eax, dword ptr [esi + (_m-L0$pb)+5457]
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5461]
	sub	esp, 4
	push	72
	push	ebx
	push	eax
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5457]
	add	eax, 72
	mov	dword ptr [esi + (_m-L0$pb)+5457], eax
	cmp	eax, 4096
	jae	LBB0_13
LBB0_15:
...
LBB0_17:
	...
	mov	eax, dword ptr [esi + (_m-L0$pb)+5457]
	lea	ecx, [eax - 72]
	mov	dword ptr [esi + (_m-L0$pb)+5457], ecx
	lea	eax, [esi + 4*eax + (_m-L0$pb)+5173]
	sub	esp, 4
	lea	esi, [ebp - 88]
	push	72
	push	eax
...
LBB1_7:
	...
	mov	edx, dword ptr [ebx + 4*edx + (_m-L1$pb)+4945]
...
Ltmp1 = LJTI1_1-L1$pb
	...
	jmp	eax
LBB1_37:
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4941]
...
## BB#39:
	...
	add	dword ptr [ebx + (_m-L1$pb)+4941], edx
	jmp	LBB1_29
LBB1_33:
	cmp	esi, 517
	je	LBB1_29
...
## BB#35:
	...
	mov	eax, dword ptr [ebx + (_m-L1$pb)+21845]
	add	ecx, eax
	cmp	ecx, 4194304
	jae	LBB1_36
## BB#45:
	add	eax, 21849
	mov	dword ptr [ebx + (_m-L1$pb)+21845], ecx
	movzx	ecx, ax
...
LBB1_42:
	...
	cmp	edx, dword ptr [ebx + (_m-L1$pb)+4941]
	jbe	LBB1_44
## BB#43:
	mov	byte ptr [ebx + (_m-L1$pb)+44], 1
	sub	esp, 12
...
LBB1_46:
	...
	jmp	LBB1_29
LBB1_10:
	mov	ecx, dword ptr [ebx + (_m-L1$pb)+4408153]
	lea	eax, [ebx + _m-L1$pb]
	add	eax, dword ptr [ebx + (_m-L1$pb)+12]
	movzx	edx, word ptr [ebx + (_m-L1$pb)+34]
	add	eax, dword ptr [ebx + 4*edx + (_m-L1$pb)+4945]
	test	ecx, ecx
	je	LBB1_12
## BB#11:
	sub	esp, 8
...
LBB1_19:
	...
	mov	edi, dword ptr [ebx + 4*eax + (_m-L1$pb)+4945]
	sub	esp, 12
	push	dword ptr [ebx + _asm2C_INT.file-L1$pb]
	call	_feof
	add	esp, 16
...
LBB1_31:
	...
	jmp	LBB1_29
LBB1_41:
	mov	dword ptr [ebx + 4*eax + (_m-L1$pb)+4945], 4280153
	mov	eax, dword ptr [ebx + (_m-L1$pb)+4941]
	mov	dword ptr [ebx + _m-L1$pb], eax
	inc	eax
	mov	dword ptr [ebx + (_m-L1$pb)+4941], eax
	jmp	LBB1_29
LBB1_44:
	...
	shl	ecx, 16
	or	ecx, eax
	mov	dword ptr [ebx + 4*edx + (_m-L1$pb)+4945], ecx
	jmp	LBB1_29
LBB1_12:
	sub	esp, 12
...
LBB10_3:
	...
	jg	LBB10_6
## BB#4:
	mov	byte ptr [eax + edx + (_m-L10$pb)+4173], cl
