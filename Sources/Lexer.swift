...
let tokenList: [(String, TokenGenerator, Int)] = [
    ...
    ("cmpsb|cmpsw|cmpsd|movsb|movsw|movsd|xlat|lodsb|lodsw|lodsd|stosb|stosw|stosd|aad|repe|rep|std|stc|cld|clc|cli|cbw|cwde|cwd|sti|cmc|pushf|popf|nop|pushad|popad|popa|pusha", { .Instruction0($0) }, 0),
    ("dec|inc|pop|push|int|neg|div|idiv|mul|imul|setb|setnz|setz|not", { .Instruction1($0) }, 0),
    ("jecxz|jcxz|je|jne|jmp|jnz|jna|jz|loope|loop|ja|jbe|jnbe|jb|jc|jnae|js|jns|jnb|jae|jnc|jge|jg|jle|jl", { .JumpInstruction($0) }, 0),
    ("xchg|cmp|movsx|movzx|mov|or|xor|and|add|adc|sbb|rol|ror|sub|shl|shr|test|in|out|lea|lds|les|lfs|lgs|sar|btr|bts|btc|bt", { .Instruction2($0) }, 0),
